...
int main(int argc, char *argv[]) {
  ...
  if (argc == 1) {
    printf(1,
           ">>> \e[1;31mplease input the command as [editor file_name]\n\e[0m");
    exit();
  }
  ...
  while (1) {
    ...
    if (input[0] == 'i' && input[1] == 'n' && input[2] == 's') {
      ...
      auto_show = 1;
      printf(1,
             ">>> \e[1;33menable show current contents after text "
             "changed.\n\e[0m");
    } else if (strcmp(input, "hide") == 0) {
      auto_show = 0;
      printf(1,
             ">>> \e[1;33mdisable show current contents after text "
             "changed.\n\e[0m");
    }
...
char *strcat_n(char *dest, char *src, int len) {
  ...
  int pos = strlen(dest);
  if (len + pos >= MAX_LINE_LENGTH) return dest;
  int i = 0;
  for (; i < len; i++) dest[i + pos] = src[i];
  dest[len + pos] = '\0';
  return dest;
}
...
void com_ins(char *text[], int n, char *extra, int flag) {
  ...
  if (text[n - 1] == NULL) {
    ...
    if (text[n - 2][0] == '\0') {
      ...
      changed = 1;
      if (auto_show == 1) show_text_syntax_highlighting(text);
      return;
    }
  }
  memset(text[n - 1], 0, MAX_LINE_LENGTH);
...
void com_exit(char *text[], char *path) {
  while (changed == 1) {
    printf(1,
           ">>> \e[1;33msave the file?\e[0m "
           "\033[1m\e[46;33my\e[0m/\033[1m\e[41;33mn\e[0m\n");
    char input[MAX_LINE_LENGTH] = {};
    gets(input, MAX_LINE_LENGTH);
    input[strlen(input) - 1] = '\0';
    if (strcmp(input, "y") == 0)
...
void com_display_color_demo() {
  ...
  printf(1,
         ...
         "---\n");
  printf(1,
         "L_BLACK: 	| \e[1;30mI am happy Shaun Fong.\e[0m	|	"
         "\e[1;30m\\e[1;30m\e[0m\n");
  printf(1,
         "BLACK: 		| \e[0;30mI am happy Shaun Fong.\e[0m	"
         "|	\e[0;30m\\e[0;30m\e[0m\n");
  printf(1,
         "RED: 		| \e[0;31mI am happy Shaun Fong.\e[0m	|	"
         "\e[0;31m\\e[0;31m\e[0m\n");
  printf(1,
         "L_RED: 		| \e[1;31mI am happy Shaun Fong.\e[0m	"
         "|	\e[1;31m\\e[1;31m\e[0m\n");
  printf(1,
         "GREEN: 		| \e[0;32mI am happy Shaun Fong.\e[0m	"
         "|	\e[0;32m\\e[0;32m\e[0m\n");
  printf(1,
         "L_GREEN: 	| \e[1;32mI am happy Shaun Fong.\e[0m	|	"
         "\e[1;32m\\e[1;32m\e[0m\n");
  printf(1,
         "YELLOW:		| \e[0;33mI am happy Shaun Fong. \e[0m	"
         "|	\e[0;33m\\e[0;33m\e[0m\n");
  printf(1,
         "L_YELLOW:	| \e[1;33mI am happy Shaun Fong. \e[0m	|	"
         "\e[1;33m\\e[1;33m\e[0m\n");
  printf(1,
         "BLUE: 		| \e[0;34mI am happy Shaun Fong. \e[0m	"
         "|	\e[0;34m\\e[0;34m\e[0m\n");
  printf(1,
         "L_BLUE:		| \e[1;34mI am happy Shaun Fong. \e[0m	"
         "|	\e[1;34m\\e[1;34m\e[0m\n");
  printf(1,
         "PURPLE:		| \e[0;35mI am happy Shaun Fong. \e[0m	"
         "|	\e[0;35m\\e[0;35m\e[0m\n");
  printf(1,
         "L_PURPLE: 	| \e[1;35mI am happy Shaun Fong. \e[0m	|	"
         "\e[1;35m\\e[1;35m\e[0m\n");
  printf(1,
         "CYAN: 		| \e[0;36mI am happy Shaun Fong. \e[0m	"
         "|	\e[0;36m\\e[0;36m\e[0m\n");
  printf(1,
         "L_CYAN:		| \e[1;36mI am happy Shaun Fong. \e[0m	"
         "|	\e[1;36m\\e[1;36m\e[0m\n");
  printf(1,
         "GRAY: 		| \e[0;37mI am happy Shaun Fong. \e[0m	"
         "|	\e[0;37m\\e[0;37m\e[0m\n");
  printf(1,
         "WHITE: 		| \e[1;37mI am happy Shaun Fong. \e[0m	"
...
void com_help(char *text[]) {
  ...
  printf(1,
         "\e[1;32mshow:\e[0m 	| enable show current contents after executing "
         "a command.\n");
  printf(1,
         "\e[1;32mhide:\e[0m 	| disable show current contents after "
         "executing a command.\n");
...
void com_init_file(char *text[], char *path) {
  ...
  strcpy(
      buf[12],
      "	memset(buf, 0, size + 1);	//Initiate every bit of buf as 0");
  ...
  strcpy(buf[22],
         "		printf(\"the real value of variable tmp_value is:%f\", "
         "tmp_value);");
  ...
  for (; text[j] != NULL; j++) {
    ...
    if (strcmp(text[j], "\n") == 0) {
      ...
      while (mark < MAX_LINE_LENGTH && text[j][mark] != NULL) {
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 'p' &&
                 text[j][mark + 1] == 'r' && text[j][mark + 2] == 'i' &&
                 text[j][mark + 3] == 'n' && text[j][mark + 4] == 't' &&
                 text[j][mark + 5] == 'f') {
        ...
        else if ((mark + 2) < MAX_LINE_LENGTH && text[j][mark] == 'i' &&
                 text[j][mark + 1] == 'n' && text[j][mark + 2] == 't') {
        ...
        else if ((mark + 4) < MAX_LINE_LENGTH && text[j][mark] == 'f' &&
                 text[j][mark + 1] == 'l' && text[j][mark + 2] == 'o' &&
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 'd' &&
                 text[j][mark + 1] == 'o' && text[j][mark + 2] == 'u' &&
        ...
        else if ((mark + 3) < MAX_LINE_LENGTH && text[j][mark] == 'c' &&
                 text[j][mark + 1] == 'h' && text[j][mark + 2] == 'a' &&
                 text[j][mark + 3] == 'r') {
          printf(1, "\e[1;34m%c\e[0m", text[j][mark]);
          printf(1, "\e[1;34m%c\e[0m", text[j][mark + 1]);
          printf(1, "\e[1;34m%c\e[0m", text[j][mark + 2]);
        ...
        else if ((mark + 1) < MAX_LINE_LENGTH && text[j][mark] == 'i' &&
                 text[j][mark + 1] == 'f') {
        ...
        else if ((mark + 3) < MAX_LINE_LENGTH && text[j][mark] == 'e' &&
                 text[j][mark + 1] == 'l' && text[j][mark + 2] == 's' &&
                 text[j][mark + 3] == 'e') {
          printf(1, "\e[1;35m%c\e[0m", text[j][mark]);
          printf(1, "\e[1;35m%c\e[0m", text[j][mark + 1]);
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 'e' &&
                 text[j][mark + 1] == 'l' && text[j][mark + 2] == 's' &&
        ...
        else if ((mark + 2) < MAX_LINE_LENGTH && text[j][mark] == 'f' &&
                 text[j][mark + 1] == 'o' && text[j][mark + 2] == 'r') {
          printf(1, "\e[1;35m%c\e[0m", text[j][mark]);
          printf(1, "\e[1;35m%c\e[0m", text[j][mark + 1]);
          printf(1, "\e[1;35m%c\e[0m", text[j][mark + 2]);
          mark = mark + 3;
        ...
        else if ((mark + 4) < MAX_LINE_LENGTH && text[j][mark] == 'w' &&
                 text[j][mark + 1] == 'h' && text[j][mark + 2] == 'i' &&
        ...
        else if ((mark + 3) < MAX_LINE_LENGTH && text[j][mark] == 'l' &&
                 text[j][mark + 1] == 'o' && text[j][mark + 2] == 'n' &&
                 text[j][mark + 3] == 'g') {
          printf(1, "\e[1;34m%c\e[0m", text[j][mark]);
          printf(1, "\e[1;34m%c\e[0m", text[j][mark + 1]);
          printf(1, "\e[1;34m%c\e[0m", text[j][mark + 2]);
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 's' &&
                 text[j][mark + 1] == 't' && text[j][mark + 2] == 'a' &&
        ...
        else if ((mark + 4) < MAX_LINE_LENGTH && text[j][mark] == 'c' &&
                 text[j][mark + 1] == 'o' && text[j][mark + 2] == 'n' &&
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 'm' &&
                 text[j][mark + 1] == 'e' && text[j][mark + 2] == 'm' &&
        ...
        else if ((mark + 3) < MAX_LINE_LENGTH && text[j][mark] == 'N' &&
                 text[j][mark + 1] == 'U' && text[j][mark + 2] == 'L' &&
                 text[j][mark + 3] == 'L') {
          printf(1, "\e[1;35m%c\e[0m", text[j][mark]);
          printf(1, "\e[1;35m%c\e[0m", text[j][mark + 1]);
          printf(1, "\e[1;35m%c\e[0m", text[j][mark + 2]);
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 'c' &&
                 text[j][mark + 1] == 'o' && text[j][mark + 2] == 'n' &&
                 text[j][mark + 3] == 't' && text[j][mark + 4] == 'i' &&
        ...
        else if ((mark + 5) < MAX_LINE_LENGTH && text[j][mark] == 'r' &&
                 text[j][mark + 1] == 'e' && text[j][mark + 2] == 't' &&
